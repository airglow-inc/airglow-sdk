export const DEFAULT_CLOUD_APP_SOURCE_URL = 'https://api.airglow.dev';
...
export function isDefaultCloudAppSourceUrl(): boolean {
  return getCloudAppSourceUrl() === trimTrailingSlash(DEFAULT_CLOUD_APP_SOURCE_URL);
}
