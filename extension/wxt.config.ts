...
export default defineConfig({
  ...
  manifest: {
    ...
    // 'tabGroups' lets us title/color the agent's "Airglow" tab group (a visible
    // marker that those tabs are agent-controlled); no new install warning.
    permissions: ['storage', 'tabs', 'tabGroups', 'userScripts', 'declarativeNetRequest', 'scripting', 'webNavigation', 'nativeMessaging', 'identity', 'identity.email', 'offscreen', 'sidePanel', 'debugger', 'alarms'],
